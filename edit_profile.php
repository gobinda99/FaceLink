...
<div id="prof">
    <div class="p_info" style="color:#3880a8; font-size:16px;">
    <?php
    ...
    <div class="update">
     <?php
$qq=mysql_query("select * from users where username='$session->username'");
while($rrr=mysql_fetch_array($qq)){

$qr=mysql_query("select * from profile where uname='$session->username'");
 while($rs=mysql_fetch_array($qr)){
?>
    ...
    <table>
    <tr>
    <td> User Name: </td> <td><?php echo $session->username; ?></td>
    </tr>

    <tr>
    <td> Email: </td> <td><?php echo $rrr['email']; ?></td>
    </tr>

    <tr>
        <td>First Name: </td>
        <td> <input type="text" name="u_first_name" value="<?php echo $rrr['first_name']; ?>" /> </td>
    </tr>

    <tr>
    <td> Last Name: </td> <td><input type="text" name="u_last_name" value="<?php echo $rrr['last_name']; ?>" /></td>
    </tr>


    <tr>
    <td> Gender: </td> <td> <input type="text" name="u_gender" value="<?php echo $rrr['gender']; ?>" /></td>
    </tr>

    <tr>
    <td> Country: </td> <td> <input type="text" name="u_country" value=" <?php echo $rrr['country']; ?> " /></td>
    </tr>
    ...
    <tr>
    <td> About Me: </td> <td><input type="text" name="u_about" value="<?php echo $rs['about']; ?>" /> </td>
    </tr>


    <tr>
    <td> Current City: </td> <td><input type="text" name="u_city" value="<?php echo $rs['city']; ?>" /></td>
    </tr>

    <tr>
    <td> Home Town: </td> <td><input type="text" name="u_town" value="<?php echo $rs['town']; ?>" /></td>
    </tr>



    <tr>
    <td align="left"> Languages known: </td> <td><input type="text" name="u_language" value="<?php echo $rs['language']; ?>" /></td>
    </tr>


    <tr> <td> </td> <td> <input type="submit" name="edit_p" value="Update Profile" /> </td> </tr>
