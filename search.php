...
<ul class="main-nav">
   ...
   <li class="a-left no-arrow"> <a href="album/home.php">PHOTOS </a> </li>
   ...
   <a href="#">ACCOUNT</a>
        <ul class="account">
        <li><a href="#"> Welcome <?php echo  $_SESSION['first_name']."&nbsp;".$_SESSION['last_name'];  ?> </a></li>
...
<img src="images/friend.png" alt="friend" width="32" height="32" class="home_img" /> <a href="#">  My Friends </a> <br/>
<img src="images/photo.png" alt="Photo" width="32" height="32" class="home_img" /> <a href="album/home.png"">  My Photos </a> <br/>
...
<div id="contenttext">
			  <div style="padding:10px">
				<?php
                                $r = mysql_query("SELECT * FROM users WHERE username='$session->username'") or die(mysql_error());
				...
				<div class="bodytext" style="padding:12px;" align="justify">
				  ...
				  <?php
				  $q=$_REQUEST['search'];
				  $qr=mysql_query("select * from users where first_name like '%$q%' or last_name like'%q%' or `username` like '%$q%' or `email` like '%$q%'");
				  while($rs=mysql_fetch_array($qr)){
				  	if($rs[1]!=$session->username){
				  ?>
					<tr>
					<td><a href="friend.php?fun=<?php echo $rs['username'] ?>"> <img src="profile/<?php echo $rs['username'] ?>.jpg" width="80" height="60" /></a></td>
					<td><?php echo $rs['first_name'] ?> &nbsp;  <?php echo $rs['last_name'] ?><br />
					<?php echo $rs['username'] ?> <br/>
					<?php echo $rs['email'] ?> <br/> <?php echo $rs['country'] ?><hr />
					</td>
					</tr>
					<?php
					}
