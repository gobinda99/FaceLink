...
<div id="p_message">
    <div class="m-form" style="padding-bottom:20px;">
    <h3> Send Message </h3>
    ...
    <table>
        <tr>
            <td>
    <input name="fun" type="hidden" value="<?php echo $fun ?>" /> </td> </tr>
     <tr> <td>
    <textarea name="m" cols="60" rows="4"></textarea></td> </tr>
     <tr> <td>
    <input name="" type="submit" value="Send" /> </td> </tr>
...
<tr> <td>
   ...
   unset($_SESSION['y']);
    ...
    <div class="show_m">
     <table>
     <?php
     $qq=mysql_query("select * from scrap where rec='$fun' and un='$session->username' order by `when` desc");
				  while($rrr=mysql_fetch_array($qq)){
				  	$x=$rrr[sen];
				  	$qr=mysql_query("select * from users where username='$x'");
				  while($rs=mysql_fetch_array($qr)){
				  	?>
					<tr>
					<td><a href="friend.php?fun=<?php echo $rs[username] ?>"> <img src="profile/<?php echo $rs[username] ?>.jpg" width="80" height="60" /></a>
                                        </td>
                                        <td style="color:#006699;">
                                        <?php echo $rs[first_name] ?> &nbsp; <?php echo $rs[last_name] ?> <br/>
                                        <?php echo $rs[email] ?><br/>
                                        <?php echo $rs[country] ?>
                                        </td>
					<td style="">
					<?php echo $rrr[what] ?> <br/>
                                        <h3 style="color:#006699;"> On &nbsp; <?php echo date('d-m-Y, h:i:s a',$rrr[when]) ?> </h3>
...
<div id="footer">
<div class="wrap">
<p class="copyright">Copyright &#169; 2011 <a class="site-link" href="index.php" title="Visual" rel="home"><span>Visual</span></a>.</p>
