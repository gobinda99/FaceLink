...
<?php
$r=mysql_query("select img from photo where un='$session->username'");
$no=mysql_num_rows($r);
if($no<1)
	echo "You have no photo in your album";
else{
	while($row=mysql_fetch_assoc($r)){
		echo "<a href=view.php?x=".$row['img']."><img src=\"album/".$row['img']."\" width=60 height=60></a>"."&nbsp;&nbsp;&nbsp;";
	}
}
?>
