...
<ul class="main-nav">
   ...
   <li class="a-left no-arrow"> <a href="#"> FRIENDS </a> </li>
...
$qr=mysql_query("select * from profile where uname='$session->username'");
 while($rs=mysql_fetch_array($qr)){
?>
    <div class="edit_pro" style="float:right;">
        <a href="edit_profile.php"><input type="button" name="edit_pr" value="Edit Profile"></a>
    </div>
    ...
    <tr>
        <td>First Name: </td>
        <td> <?php echo $rrr['first_name']; ?> </td>
    </tr>

    <tr>
    <td> Last Name: </td> <td><?php echo $rrr['last_name']; ?></td>
    </tr>

    <tr>
    <td> About Me: </td> <td><?php echo $rs['about']; ?></td>
    </tr>

    <tr>
    <td> Gender: </td> <td><?php echo $rrr['gender']; ?></td>
    </tr>

    <tr>
    <td> Country: </td> <td><?php echo $rrr['country']; ?></td>
    </tr>

    <tr>
    <td> Current City: </td> <td><?php echo $rs['city']; ?></td>
    </tr>

    <tr>
    <td> Home Town: </td> <td><?php echo $rs['town']; ?></td>
    </tr>

    <tr>
    <td> Date of Birth: </td> <td><?php echo $rs['month']."&nbsp; -".$rs['day']."&nbsp; -".$rs['year']; ?></td>
    </tr>

    <tr>
    <td align="left"> Languages known: </td> <td><?php echo $rs['language']; ?></td>
    </tr>

    <tr>
    <td align="left"> Interest: </td> <td><?php echo $rs['interest1']."&nbsp; and &nbsp;".$rs['interest2']; ?></td>
    </tr>
